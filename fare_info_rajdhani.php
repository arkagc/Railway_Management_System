	...
	<body>
	   <div class="wrapper">
			<div class="header">
				<div class="row">
					<div class="logo">
						...
						<h1><i><u>INDIAN RAILWAYS</u></i></h1>
						<h2><i><u>PASSENGERS RESERVATION</u></i></h2>
					</div>
					<ul class="main-nav">
		...
		<br><br>
			...
			<div >
						<span style="padding-left:1155px"><img src="image/paytm.jpg" height="590" width="330">
			</div>
		
		<div class="navigation4" action="">
				<h1><u>RAJDHANI EXPRESS FARE DETAILS</u></h1></br>
					<center><table border="1" class="view" bordercolor="RED" width="800">
					
							<tr>
							<td><font color="blue"/>  Train Number   </td>
							<td><font color="BLUE"/>   Train Name   </td>
							<td><font color="BLUE"/>   Source Station   </td>
							<td><font color="BLUE"/>   Destination Station   </td>
							<td><font color="BLUE"/>   Class   </td>
							<td><font color="BLUE"/>   age   </td>
							<td><font color="BLUE"/>   Fare   </td>
					...
					<br>
					<br>
					<table border="1" class="view" bordercolor="RED" width="800">
